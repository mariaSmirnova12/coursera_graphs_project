...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i = 0; i < getNumVertices(); i++) {
			List<Integer> neibOut = getNeighbors(i);
			List<Integer> neibIn = getInNeighbors(i);
			degreeSequence.add(neibOut.size() + neibIn.size());
		}
	...
	public static void main (String[] args) {
		...
		loader.loadRoadMap("data/testdata/simpletest.map", graphFromFile);
		...
		loader.loadRoutes("data/airports/routesUA.dat", airportGraph);
