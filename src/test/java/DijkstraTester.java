...
public class DijkstraTester {
    ...
    public void testDijkstra1() {
        ...
        System.out.println("Test 1 using simpletest: for Dijkstra should be 9 points seen");
        List<GeographicPoint> testroute = testMap.dijkstra(testStart,testEnd);
        assertEquals(9, testMap.getCount());
    ...
    public void testDijkstra2() {
        ...
        System.out.println("Test 2: for Dijkstra should be 13 points seen");
        List<GeographicPoint> testroute = testMap.dijkstra(testStart,testEnd);
        assertEquals(13, testMap.getCount());
    }
    ...
    public void testDijkstra3() {
        ...
        System.out.println("Test 3: for A* star should be 37 points seen");
        List<GeographicPoint> testroute = testMap.dijkstra(testStart,testEnd);
        assertEquals(37, testMap.getCount());
    }
